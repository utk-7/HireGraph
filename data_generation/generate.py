...
def run_generation(seed, scale, output_dir):
    ...
    interview_reviews = sum(1 for n in nodes.get("Review", []) if n.get("review_type") == "interview_experience")
    employee_reviews = sum(1 for n in nodes.get("Review", []) if n.get("review_type") == "employee_experience")
